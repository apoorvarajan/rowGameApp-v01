...
public class TicTacToeGame {
	...
	Logger.log("uses inside move");
	Logger.log("manipulates inside move");
	--movesLeft;
	if(movesLeft%2 == 1) {
	...
	Logger.log("updates in updateBlock");
    }
	...
	Logger.log("uses in resetgame");
	Logger.log("manipulates in resetgame");
        for(int row = 0;row<3;row++) {
            for(int column = 0;column<3;column++) {
